...
const Reset: React.FC<ResetProps> = ({}) => {
	...
	const passwordValues: PasswordValues = {
		oldPassword: "",
		newPassword: "",
		confirmPassword: "",
	};
				...
				<div className="flex w-full m-auto mt-0 shadow-xl lg:w-4/12 md:w-10/12 md:mt-28 bg-base-200 rounded-xl">
					<div className="mx-auto w-96">
						...
						{ApiResponse.password ? (
							<p className="p-4 m-10 mx-auto font-bold text-center border text-md text-error rounded-xl border-error">
								Invalid password
							</p>
						) : null}
						<Formik
