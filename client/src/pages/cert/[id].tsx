						...
						<div className="md:flex no-wrap md:-mx-2">
									...
									<ul className="px-3 py-2 mt-3 divide-y rounded shadow-sm hover:shadow">
										<li className="flex items-center py-3">
											...
											<span className="ml-auto">
												<span className="px-2 py-1 text-sm uppercase rounded">
													{user.accountStatus}
												</span>
											</span>
										</li>
							...
							<div className="w-full lg:mx-2 md:w-9/12">
								<div className="p-3 rounded-lg shadow-sm bg-base-300 lg:h-72">
									...
									<label
										htmlFor="edit-modal"
										className="w-full p-3 my-4 text-sm font-semibold rounded-lg btn modal-button focus:outline-none focus:shadow-outline hover:shadow-xs"
									>
										More
									</label>
								</div>
...
export default withAuth(AuthOption.ANY, Me);
