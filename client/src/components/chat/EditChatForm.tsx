...
export const EditChatForm: React.FC<EditChatFormProps> = () => {
	...
	const submitChatRoom = async (
		values: ChatRoomValues,
		helpers: FormikHelpers<ChatRoomValues>
	) => {
		try {
						...
						>
							{({
								...
								<Form>
									...
									<div>
										<div className="form-control">
											<label className="cursor-pointer label">
												...
												<Field
													placeholder="Enter your chat access"
													type="checkbox"
													name="isPublic"
													className={`checkbox`}
												/>
									...
									>
										<AiTwotoneEdit />{" "}
										<p className="ml-2">Edit chatroom</p>
									</button>
								</Form>
							)}
						</Formik>
